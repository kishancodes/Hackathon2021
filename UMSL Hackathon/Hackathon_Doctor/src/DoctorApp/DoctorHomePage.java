...
public class DoctorHomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Paitent 1", "Paitent 2", "Paitent 3", "Paitent 4", " " };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(jList1);

        jLabel1.setText("Paitent List:");

        jLabel2.setText("Paitent Description");

        jList2.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Insurance ID Number:", "Insurance Provider:", "Phone Number: ", "Address: ", "Emergency Contact 1", "Emergency Contact 2", " " };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(jList2);

        jButton1.setText("Add Paitent");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ViewPatient ds = new ViewPatient();
        ds.setVisible(true);
        this.setVisible(false);        
